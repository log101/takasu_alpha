...
Trade.create(id: 1, sender_id: 1, recipient_id: 2, status:true)
TradeItem.create(trade_id: 1, manga_id: 1)
TradeItem.create(trade_id: 1, manga_id: 2)
TradeItem.create(trade_id: 1, manga_id: 3)
TradeItem.create(trade_id: 1, manga_id: 4)