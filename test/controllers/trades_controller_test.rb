...
class TradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trade" do
    assert_difference("Trade.count") do
      post trades_url, params: { trade: { recipient_id: @trade.recipient_id, sender_id: @trade.sender_id } }
    end
  ...
  test "should update trade" do
    patch trade_url(@trade), params: { trade: { recipient_id: @trade.recipient_id, sender_id: @trade.sender_id } }
